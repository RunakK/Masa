...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var button = document.querySelector('.header-example__burger');
  button.addEventListener('click', function () {
    button.classList.toggle('btn--blue');
  });
  var overlay = document.querySelector('.header-example__overlay');
  overlay.addEventListener('click', function () {
    button.classList.remove('btn--blue');
  });
  var closeMenuHead = document.querySelector('[data-close-menu]');
  closeMenuHead.addEventListener('click', function () {
    button.classList.remove('btn--blue');
  });
  ...
  var programs = new Swiper('.programs__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
  ...
  var imgFilters = document.querySelector('.filters');
  var filterDefault = imgFilters.querySelector('#filter-default');
  var filterVolunteer = imgFilters.querySelector('#volunteer');
  var filterDiscussed = imgFilters.querySelector('#filter-discussed');
  var filterСareer = imgFilters.querySelector('#filter-career');
  var filterTrips = imgFilters.querySelector('#filter-trips');
  var chooseFilter = function chooseFilter(filterType) {
  ...
  var setListenersOnFilters = function setListenersOnFilters() {
    filterDefault.addEventListener('click', function (evt) {
      chooseFilter(evt.target);
    });
    filterVolunteer.addEventListener('click', function (evt) {
      chooseFilter(evt.target);
    });
    filterDiscussed.addEventListener('click', function (evt) {
      chooseFilter(evt.target);
    });
    filterСareer.addEventListener('click', function (evt) {
      chooseFilter(evt.target);
    });
    filterTrips.addEventListener('click', function (evt) {
      chooseFilter(evt.target);
    });
  };
  setListenersOnFilters();
  var news = new Swiper('.news__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    slidesPerView: 'auto',
  ...
  var map = L.map('map').setView([55.028527396640804, 82.92824989073691], 17);
  ...
  L.marker([55.028527396640804, 82.92824989073691], {
    icon: greenIcon
  }).addTo(map);
...
},{"./modules/accordion":3,"./modules/form-validate/form":6,"./modules/header":14,"./modules/modals/init-modals":20,"./modules/select":24,"./modules/tabs":26,"./utils/ios-vh-fix":31,"./vendor/leaflet/leaflet":33}],2:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":13,"./scroll-lock":18}],13:[function(require,module,exports){
"use strict";
...
},{"./burger":12,"./init-locomotive-scroll":15,"./locomotive-scroll":17,"./sticky-header":19}],15:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":29,"../../utils/scroll-lock":32}],22:[function(require,module,exports){
"use strict";
...
},{"./create-select-markup":22,"./utils":25}],24:[function(require,module,exports){
"use strict";
...
},{"./custom-select":23}],25:[function(require,module,exports){
"use strict";
...
},{"./init-tabs":27}],27:[function(require,module,exports){
"use strict";
...
},{"./tabs":28}],28:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":30,"dup":18}],33:[function(require,module,exports){
"use strict";
